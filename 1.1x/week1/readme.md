...
Языки программирования основаны на парадигмах программирования. Языков много, парадигм (популярных) — несколько. Освоив парадигмы мы сможем достаточно легко осваивать разные языки, которые на них основаны. Более того, разные парадигмы основаны на определенных концепциях, которые могут быть общими у разных парадигм:
...
Программы пишут, чтобы решать определенные задачи. Для решения разных задач подходят разные языки программирования, которые следуют разным парадигмам.
...
Исторически вся информатика стремится к декларативности: в программе описывать желаемый результат, а не процесс его достижения.
...
Композиция — возможность ф-и вызывать другие функции. Ничего такого, просто в одной функции мы пользуемся другими функциями. Композиция — первй шаг к абстракции данных. Мы не знаем точно, что делает функция, которую мы используем внутри нашей, но мы знаем, как ей пользоваться.

Рекурсия — возможность ф-и вызывать саму себя. Пример с отсутствием терминального условия (без `if`).

Рекурсия — частный случай композиции (ф-я вызываем не другие ф-и, а саму себя).
...
## Условия
Возможность изменять процесс исполнения программы в зависимости от результатов каких-то вычислений.
